    ...
    <Container inner="py-14">
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-14">
        ...
        <section className="flex flex-col">
          <h2 className="py-3 !text-5xl text-[#fff]">Hey, I'm Jay.</h2>
          <p className="py-3 text-xl text-[#C1C1C1] whitespace-pre-line">
            {`
...
`}
          ...
          <p className="py-5 text-[#fff]">Signature</p>
          <div className="py-3 flex items-start">
            {socialMedia?.map((d, i) => {
              return (
                ...
                <p
                  key={i}
                  className="text-[#C1C1C1] text-xl mr-3 cursor-pointer flex-wrap my-2"
                >
                  {d?.name}
                </p>
              );
